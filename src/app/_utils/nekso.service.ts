...
this.drivers = [
	{ firstName: 'Mauricio', lastName: 'Muñoz', username: 'Mau123', email: 'mauriciomunoz@gmail.com', address: '1873 Clay Street', city: 'Indianapolis', state: 'Indiana', zip: '46254', phone: '317-385-2513', gender: 'Hombre', image: 'assets/drivers/0.jpg' },
	{ firstName: 'Oswaldo', lastName: 'Gutierrez', username: 'Oso456', email: 'oswaldogutierrez@gmail.com', address: '1842 Saint Clair Street', city: 'Greenwood', state: 'Mississippi', zip: '38930', phone:'662-626-2620', gender: 'Hombre', image: 'assets/drivers/1.jpg' },
	{ firstName: 'Victor', lastName: 'Ballinas', username: 'Vic987', email: 'victorballinas@gmail.com', address: '4177 Friendship Lane', city: 'San Martin', state: 'California', zip: '95046', phone: '408-681-8740', gender: 'Hombre', image: 'assets/drivers/2.jpg' },
	{ firstName: 'Jorge', lastName: 'Vazquez', username: 'Yorch213', email: 'jorgevazquez@gmail.com', address: '3208 Kelly Street', city: 'Charlotte', state: 'North Carolina', zip: '28263', phone: '704-975-1325', gender: 'Hombre', image: 'assets/drivers/3.jpg' },
	{ firstName: 'Efrain', lastName: 'Ramos', username: 'Efra654', email: 'efrainramos@gmail.com', address: '2499 Jadewood Drive', city: 'Chicago', state: 'Illinois', zip: '60606', phone: '224-484-7871', gender: 'Hombre', image: 'assets/drivers/4.jpg' },
	{ firstName: 'Saul', lastName: 'Morales', username: 'Moss963', email: 'saulmorales@gmail.com', address: '3554 Oak Drive', city: 'Albany', state: 'New York', zip: '12206', phone: '518-591-3328', gender: 'Hombre', image: 'assets/drivers/5.jpg' }
]
